// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.6.0-149.3.beta.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t2,
        canvas = type$.CanvasElement._as(document.querySelector("#circleCanvas")),
        ctx = type$.CanvasRenderingContext2D._as(B.CanvasElement_methods.getContext$1(canvas, "2d")),
        t1 = canvas.width;
      t1.toString;
      t2 = canvas.height;
      t2.toString;
      B.CanvasRenderingContext2D_methods.set$fillStyle(ctx, "blue");
      ctx.beginPath();
      ctx.arc(t1 / 2, t2 / 2, 94.48818897637796, 0, 6.283185307179586, false);
      ctx.closePath();
      ctx.fill();
    }
  },
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.CanvasRenderingContext2D, A.DomException]);
